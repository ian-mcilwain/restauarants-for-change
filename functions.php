...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('logo', 150, auto, true);
...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
    ...
    wp_enqueue_script(
    'mailChimp', //handle
    get_template_directory_uri() . '/js/mailchimp.js', //source
    array( 'jquery', 'plugins',  ), //dependencies
    null, // version number
    true //load in footer
  );
    ...
    wp_enqueue_script(
    'mapApp', //handle
    get_template_directory_uri() . '/js/mapApp.js', //source
...
function hackeryou_widgets_init() {
	...
	register_sidebar( array(
		'name' => 'Who Benefits Logo Widget Area',
		'id' => 'who-benefits-logo-widget-area',
		'description' => 'The about section logo widget area',
		'before_widget' => '<div class="aboutLogoContainers">',
		'after_widget' => '</div>',
		'before_title' => '<p>',
		'after_title' => '</p>',
	) );
		...
		register_sidebar( array(
		'name' => 'National Sponsor Logo Widget Area',
		'id' => 'national-sponsor-logo-widget-area',
		'description' => 'The national sponsor logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
		...
		register_sidebar( array(
		'name' => 'National Media Sponsor Logo Widget Area',
		'id' => 'national-media-sponsor-logo-widget-area',
		'description' => 'The media sponsor logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
		...
		register_sidebar( array(
		'name' => 'Regional Media Sponsor Logo Widget Area',
		'id' => 'regional-media-sponsor-logo-widget-area',
		'description' => 'The media sponsor logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		...
		register_sidebar( array(
		'name' => 'Event Sponsor Logo Widget Area',
		'id' => 'event-sponsor-logo-widget-area',
		'description' => 'The event sponsor logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
		...
		register_sidebar( array(
		'name' => 'community Sponsor Logo Widget Area',
		'id' => 'community-sponsor-logo-widget-area',
		'description' => 'The community sponsor logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
			...
			register_sidebar( array(
		'name' => 'Other Sponsor Logo Widget Area',
		'id' => 'other-sponsor-logo-widget-area',
		'description' => 'The other sponsor logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
		...
		register_sidebar( array(
		'name' => 'Restaurant List Widget Area',
		'id' => 'restaurant-sponsor-logo-widget-area',
		'description' => 'The restaurant sponsor logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
